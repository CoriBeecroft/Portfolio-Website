...
const IntroTile = () => {
    return <div id="intro" className="tile color1">
...
const Forty96 = () => {
    return <div id="forty96" className="tile color2">
        <div className="container">
    ...
    return <div id="HNFE" className="tile color0">
        <div className="container">
            ...
            <section>
                <h3>TODO: </h3>
                <span>
                    Note: I'm not actively working on this project anymore
                    since the main purpose of it was to learn React and what's
                    left to do won't contribute significantly to my
                    knowledge/understanding of React.
                </span>
                <ul>
...
const NestingDocs = () => {
    return <div id="nesting-docs" className="tile color1">
        <div className="container">
            <div className="row">
...
const Lucidity = () => {
    return <div id="lucidity" className="tile color2">
        <div className="container">
            <div className="row">
                <h2 className="col-lg-12">Lucidity</h2>
                <h4>
                    <a href="http://symbolflux.com/projects/avd" target="_blank">
                        (Click here for more information on Lucidity)
                    </a>
                </h4>
            </div>
            <div>
...
const DoomPet = () => {
    return <div id="doom-pet" className="tile color0">
        <div className="container">
